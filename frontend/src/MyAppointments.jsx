...
class MyAppointments extends Component {
  ...
  fetchAppointments = () => {
    ...
    Apicall(
      "GET",
      `${import.meta.env.VITE_BASE_URL}/appointments/list`,
      "",
      (res) => {
  ...
  handleDelete = (id) => {
    ...
    Apicall(
      "DELETE",
      `${import.meta.env.VITE_BASE_URL}/appointments/delete/${id}`,
      "",
      (res) => {
        this.setState({ loading: false });
  ...
  handleEditSubmit = (e) => {
    ...
    Apicall(
      "PUT",
      `${import.meta.env.VITE_BASE_URL}/appointments/update/${editAppointment.id}`,
